...
module Swagger
  ...
  class Request
    ...
    def initialize(http_method, path, attributes={})
      ...
      if attributes[:require_auth]
        ...
        when 'query' # API key in url query
          ...
          unless Swagger.configuration.username.blank? || Swagger.configuration.password.blank?
            # HTTP basic
      ...
      # set user-agent
      attributes[:headers]['User-Agent'] = Swagger.configuration.user_agent
    ...
    def interpreted_path
      ...
      # Comment out as path params already substituted with values
